      ...
      <Card className="bg-gray-900/95 backdrop-blur-xl border-gray-700/50 shadow-2xl">
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <Badge className="bg-success-500/20 text-success-400 border-success-500/30">Live Search</Badge>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-4">
            <Select value={searchData.make} onValueChange={(value) => setSearchData({ ...searchData, make: value })}>
              <SelectTrigger className="bg-gray-800/70 border-gray-600/50 text-white hover:bg-gray-800/80">
            ...
            <Input
              ...
              className="bg-gray-800/70 border-gray-600/50 text-white placeholder:text-gray-400 hover:border-primary-500/50 focus:border-primary-500/70 focus:ring-1 focus:ring-primary-500/30"
            />
            ...
            <Button
              ...
              className="bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold shadow-lg hover:shadow-primary-500/20 transition-all duration-300"
            >
          ...
          <div className="flex items-center justify-between">
            <Button
              ...
              className="text-gray-400 hover:text-white p-0 h-auto hover:bg-transparent"
            >
